...
# Deskripsi  : Membuat tipe bentukan pecahan beserta konstruktor, selektor, operator, dan predikatnya
...
# <n: integer, d: integer>0> n adalah pembilang (numerator) dan d adalah penyebut (denumerator), dengan penyebut sebuah pecahan tidak boleh nol
...
# AddP(P1,P2) menjumlahkan dua buah pecahan P1 dan P2: (n1/d1)+(n2/d2) = (n1*d2+n2*d1)/d1*d2
# REALISASI
def AddP(P1,P2):
...
# APLIKASI
print(AddP(MakeP(-5,10),MakeP(10,99)))
print(SubP(MakeP(1,2),MakeP(3,4)))
print(MulP(MakeP(-1,9),MakeP(892,4)))
print(DivP(MakeP(1,2),MakeP(-1,4)))
