...
def isJajarGenjang(p1,p2,p3,p4):
    if panjangAbsis(p1,p2) == panjangAbsis(p3,p4) and panjangOrdinat(p1,p3) == panjangOrdinat(p2,p4):
        return gradien(p1,p3) == gradien(p2,p4) and gradien(p1,p2) * gradien(p2,p4) != -1
    elif panjangAbsis(p2,p3) == panjangAbsis(p1,p4) and panjangOrdinat(p2,p1) == panjangOrdinat(p3,p4):
        return gradien(p2,p1) == gradien(p3,p4) and gradien(p2,p3) * gradien(p3,p4) != -1
    elif panjangAbsis(p1,p3) == panjangAbsis(p2,p4) and panjangOrdinat(p1,p2) == panjangOrdinat(p3,p4):
        return gradien(p1,p2) == gradien(p3,p4) and gradien(p1,p3) * gradien(p3,p4) != -1
    else:
        return False
