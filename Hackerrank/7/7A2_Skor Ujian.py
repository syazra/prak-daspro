...
def JumlahPolaNaik(L):
    if IsEmpty(Tail(Tail(L))):
        return 0
    elif FirstElmt(L) < FirstElmt(Tail(L)) < FirstElmt(Tail(Tail(L))):
        return 1 + JumlahPolaNaik(Tail(L))
    else:
        return JumlahPolaNaik(Tail(L))


print(JumlahPolaNaik([9, 90, 88, 7, 88, 99, 100, 88, 101, 990]))