...
def panjang(L):
    if IsEmpty(L):
        ...
        return 1
    elif FirstElmt(L) == FirstElmt(Tail(L)):
        return 1 + panjang(Tail(L))
    else:
        return 1
...
def warnaBalon(L):
    if IsEmpty(L):
        ...
        return max(panjang(L), warnaBalon(Tail(L)))
          
print(warnaBalon([1]))
print(warnaBalon([1,8,3]))
print(warnaBalon([1,2,1,3,1,2,3,3]))
print(warnaBalon([1,5,4,4,4,2,3,3]))